...
| **Offline verifier** | The procedure (and reference library) that re-derives integrity, lineage, scope-respect, and grounding from chain bytes + public trust anchors, with zero operator reads. |
